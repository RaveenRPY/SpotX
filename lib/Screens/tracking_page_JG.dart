...
class TrackJG extends StatefulWidget {
  const TrackJG({Key? key}) : super(key: key);

  @override
  State<TrackJG> createState() => _TrackJGState();
}

class _TrackJGState extends State<TrackJG> with WidgetsBindingObserver {
                          ...
                          child: Row(
                            children: [
                              SizedBox(
                                width: 200,
                                child: Image(
                                  image: AssetImage('lib/assets/old/JG.png'),
                                  fit: BoxFit.contain,
                                ),
                              ),
                            ],
